        ...
        <div class="heading page-header">
            <div class="container-fluid">
                ...
                <div class="pull-right">
                    <a onclick="jQuery('[name=action]').val('apply');BrainyFilterAdm.submitForm();" class="btn btn-success" data-toggle="tooltip" title="<?php echo $button_save; ?>"><i class="fa fa-save"></i></a>
                    <a onclick="BrainyFilterAdm.submitForm();" class="btn btn-primary" data-toggle="tooltip" title="<?php echo $button_save_n_close; ?>"><span class="icon"></span><i class="fa fa-save"></i></a>
                ...
                <div class="bf-panel">
                    ...
                    <div data-group="help-tabs" id="bf-about" class="tab-content with-border">
                        <div class="bf-about-text">
                            ...
                            <hr />
                            <p>Brainy Filter Ultimate 4.6.1 OC2. <a href="http://giantleaplab.com/">Giant Leap Lab</a> &copy; 2014</p>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="bf-adm-template" style="display: none;" data-layout-id="">
    ...
    <div id="bf-filter-behaviour-{m}" class="tab-content with-border" data-group="settings-{m}">
        <div class="bf-filter-title">
            ...
            <div>
                 <table class="bf-adm-table bf-adm-langs">
                    <tr>
                        <th>
                            <ul class="htabs nav nav-tabs">
                                <?php $i = 0; foreach ($languages as $language) : $i ++; ?>
                                <li class="tab <?php if($i === 1): ?>selected<?php endif; ?>" data-target="#tab-language-<?php echo $language['language_id']; ?>-{m}">
                                    <a>
                            ...
                            <div class="bf-adm-label-td bf-filter-title-inputs">
                                <?php foreach ($languages as $language) : ?>
                                <div id="tab-language-<?php echo $language['language_id']; ?>-{m}" class="tab-content bf-w195" data-group="tab-language-{m}">
...
BrainyFilterAdm.currentModule = <?php echo ($currentModule === false) ? 'false' : $currentModule; ?>;
BrainyFilterAdm.isFirstLaunch = <?php echo $isFirstLaunch; ?>;
BrainyFilterAdm.modRefreshActionUrl = '<?php echo str_replace('&amp;', '&', $modRefreshAction); ?>';
