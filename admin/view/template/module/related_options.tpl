...
<div id="content">
				...
				<table class="form">
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" name="related_options[price_residue]" value="<?php echo $module_data['price_residue'] ?>" />
                            </td>
	...
	<p><small>&copy; <a href="http://itcraft.ru/" target="_blank">iTCraft</a></small></p>
	</div>
</div>
<style>
.htabs {
