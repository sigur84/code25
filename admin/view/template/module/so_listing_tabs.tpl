							...
							<div class="tab-content">
								<div class="tab-pane" id="module"> <!--Module-->
									...
									<div class="form-group type_show_loadmore <?php echo ($module['type_show'] == 'loadmore') ? 'hide' : ''; ?>"> <!--Loadmore -->
										...
										<div class="col-sm-9">
											<div class="col-sm-5">
												<input type="text" name="nb_rows" value="<?php echo $module['nb_rows']; ?>" id="input-nb_rows" class="form-control" />
											</div>
											<?php if (isset($error['nb_rows'])) { ?>
											<div class="text-danger col-sm-12"><?php echo $error['nb_rows']; ?></div>
											<?php }?>
										</div>
									</div>
								</div>
