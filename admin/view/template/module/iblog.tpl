                ...
                <div class="tabbable">
                    <div class="tab-navigation form-inline">
                        <ul class="nav nav-tabs mainMenuTabs" id="mainTabs">
							...
							<li><a href="#categories" role="tab" data-toggle="tab"><i class="fa fa-folder-open-o"></i>&nbsp;Blog Categories</a></li>
                        ...
                        <div class="tab-buttons">
                        	<a id="addNewPost" href="<?php echo $url->link('module/'.$moduleNameSmall.'/newBlogPost', 'token=' . $token."&store_id=".$store['store_id'], 'SSL'); ?>" class="btn btn-info addNewPost"><i class="fa fa-file-text-o"></i>&nbsp;&nbsp;Add new post</a>
                            <a href="<?php echo $catalog_url; ?>index.php?route=feed/iblog" target="_blank" class="btn btn-default"><i class="fa fa-rss"></i>&nbsp;&nbsp;RSS Feed</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <button type="submit" class="btn btn-success save-changes"><i class="fa fa-check"></i>&nbsp;Save</button>
                    ...
                    <div class="tab-content">
						...
						<div id="blogs" class="tab-pane"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/module/'.$moduleNameSmall.'/tab_blogs.php'); ?></div>
 						<div id="categories" class="tab-pane"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/module/'.$moduleNameSmall.'/tab_categories.php'); ?></div>
