						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<ul class="nav nav-tabs" >
									...
									<li class="<?php echo ($subfix == 'lg' ? 'active' : ''); ?>"><a href="#language-catalog_refine_<?php echo $subfix ?>" data-toggle="tab"><?php echo $device ?></a></li>
									<?php endforeach; ?>
								</ul>
								<div class="tab-content">
									<?php foreach ($devices as $subfix => $device) : ?>
									<div class="tab-pane <?php echo ($subfix == 'lg' ? 'active' : ''); ?>" id="language-catalog_refine_<?php echo $subfix ?>">
					...
					<div class="panel-container">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<ul class="nav nav-tabs" >
									<?php foreach ($devices as $subfix => $device) : ?>
									<li class="<?php echo ($subfix == 'lg' ? 'active' : ''); ?>"><a href="#language-product_catalog_<?php echo $subfix ?>" data-toggle="tab"><?php echo $device ?></a></li>
									<?php endforeach; ?>
								</ul>
								<div class="tab-content">
									<?php foreach ($devices as $subfix => $device) : ?>
									<div class="tab-pane <?php echo ($subfix == 'lg' ? 'active' : ''); ?>" id="language-product_catalog_<?php echo $subfix ?>">
