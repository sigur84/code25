              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <?php if ($name == 'Footer' || $name == 'footer') { ?> 
                 ...
                 <?php } else { ?>   
                    ...
                    <?php } else { ?>
                    <option value="content_menu">Content Menu</option>
                    <?php } ?>
                    ...
                    <option value="content_block5" selected="selected">Content Block 5</option>
                    <?php } else { ?>
                    <option value="content_block5">Content Block 5</option>
                    <?php } ?>
					<?php if ($layout_module['position'] == 'content_block6') { ?>
                    <option value="content_block6" selected="selected">Content Block 6</option>
                    <?php } else { ?>
                    <option value="content_block6">Content Block 6</option>
                    <?php } ?>
                  <?php } ?>  
...
function addModule() {
	...
	html += '    <option value="content_block5">Content Block 5</option>';
	html += '    <option value="content_block4">Content Block 4</option>';
	html += '    <option value="content_block6">Content Block 6</option>';
	<?php if (isset($is_home)) { ?>
