...
class ControllerModuleiBlog extends Controller {
	...
	public function listing() {
		...
		// Document Meta
		if (!empty($data['moduleData']['LinkTitle'][$language_id])) {
			$this->document->setTitle($data['moduleData']['LinkTitle'][$language_id]);
		} else {
			$this->document->setTitle($this->language->get('heading_title'));
		}
	...
	public function tag() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/'.$this->moduleNameSmall.'-tag.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template').'/template/module/'.$this->moduleNameSmall.'-tag.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/module/'.$this->moduleNameSmall.'-tag.tpl', $data));
		}  
	}
	...
	public function category() {
		...
		$data['footer']						= $this->load->controller('common/footer');
		$data['header']						= $this->load->controller('common/header');
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/'.$this->moduleNameSmall.'-category.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template').'/template/module/'.$this->moduleNameSmall.'-category.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/module/'.$this->moduleNameSmall.'-category.tpl', $data));
		}  
