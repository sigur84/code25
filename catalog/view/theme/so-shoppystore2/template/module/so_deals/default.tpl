...
<div class="module <?php echo $class_suffix; ?>">
            ...
            ?>
                ...
                <div class="product-thumb  ">
                    ...
                    <div class="caption caption-dev">
                        ...
                        <h4 class="title-dev"><a href="<?php echo $product['href']; ?>" target="<?php echo $item_link_target;?>"><?php echo $product['name']; ?></a></h4>
                        <?php } ?>
        ...
        jQuery(document).ready(function ($) {
            ...
            (function (element) {
                ...
                $extraslider.on('initialized.owl.carousel2', function () {
                    ...
                    $('.owl2dots', $element).insertAfter($('.owl2-prev', $element));
                    <?php }else{ ?>
    ...
    echo '<p style="padding: 12em 0;text-align: center;">'.$NoItem.'</p>';
    }
    ?>
</div>
