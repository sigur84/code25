		  ...
		  <div class="left-content-product <?php echo (!empty($column_right)  || isset($html_product_right) && $html_product_right != '' && $html_product_right != '<p>&nbsp;</p>' ? 'col-lg-12 col-xs-12' : 'col-xs-12'); ?>">
			...
			<?php //Img Gallery Block -------?>
                ...
                <div class="content-product-left  <?php if(isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left'){echo "col-md-7 col-xs-12"; }else { echo "position-bottom col-md-6 col-xs-12"; } ?> ">
					...
					<div class="large-image <?php echo (isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left') ? ' vertical ' : ''; ?> <?php echo isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left' && $images ? "col-xs-9" : "" ?>">
                    ...
                    <?php if ($images  && (isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'bottom')) : ?>
                        <div id="thumb-slider" class="owl-theme owl-loaded owl-drag <?php echo ((count($images) < 3 ) ? 'not_full_slider' : 'full_slider'); ?> <?php echo (isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left' ? 'flexslider-large visible-xs' : 'owl-carousel'); ?>">
							<?php
							if (sizeof($images) > 0) {
								$firstimg = array('popup' => $popup,'thumb' => $thumb);
								array_unshift($images, $firstimg);
