	...
	<header id="header" class=" variant<?php echo $header_type; ?>">
			...
			<div class="container">
			   ...
			   <?php if ($header_type == 'center') { ?>
				 <?php 
					...
					<div class="navbar-logo col-md-7 col-sm-12 col-xs-12 text-center">
						<?php if ($logo) { ?>
			   ...
			   <!--end header variant center-->
				    ...
				    <?php } else { ?>
				    <!-- Logo -->
				    <div class="navbar-logo col-md-7 col-sm-12 col-xs-12">
					   <?php if ($logo) { ?>
					   <a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a>
					   <?php } else { ?>
					   <h1><a href="<?php echo $home; ?>"><?php echo $name; ?></a></h1>
		...
		<section class="header-bottom">
			...
			<div class="row">
				...
				<?php endif ?>
				<!-- Main menu -->
				<div class="header-bottom-right <?php  echo (isset($str) && !empty($str)) ? ' col-md-7 col-sm-6 col-xs-6 ' : 'col-xs-12' ;?>">
				   <?php if (trim($content_menu)): ?>
							<?php echo $content_menu;?>
				   <?php endif ?>
				    <!-- //end Navbar -->
				</div>
				 <div class="shopping_cart pull-right col-md-2 col-sm-6 col-xs-6">
					   <!--cart desktop-->
					   <?php
