		...
		<div class="row box checkout_form">
			...
			<div class="row">
				  ...
				  <div class="form-group col-md-6 " style="display:none;">
				    ...
				    <input type="text" name="fax" value="nofax" id="input-payment-fax" class="form-control" <?php if (isset($customer_id)) {?> readonly<?php }?>/>
				  </div>
				  <?php //}?>
			    ...
			    <?php if (isset($customer_id)) {?>	  
				  ...
				  <div class="form-group col-md-6" style="display:none;">
				    ...
				    <input type="text" name="company_id" value="nocompany" id="input-payment-company-id" class="form-control" />
				  </div>
				   <?php } else {?>
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
        ...
        success: function(json) {
            ...
            $('select[name=\'zone_id\']').html(html).val("3490");
        },
        error: function(xhr, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
        }
...
$('select[name=\'shipping_country_id\']').on('change', function() {
	$.ajax({
        ...
        success: function(json) {
            ...
            $('select[name=\'shipping_zone_id\']').html(html).val("3490");
        },
        error: function(xhr, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
        }
...
{
	if (this.name == 'contry_id') jQuery("select[name=\'zone_id\']").val("3490");
	if (this.name == 'shipping_country_id') jQuery("select[name=\'shipping_zone_id\']").val("3490");
