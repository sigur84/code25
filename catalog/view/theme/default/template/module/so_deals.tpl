...
<div class="module">
    ...
    $class_respl = 'preset01-'.$nb_column0.' preset02-'.$nb_column1.' preset03-'.$nb_column2.' preset04-'.$nb_column3.'';
    ?>
    <div id="<?php echo $tag_id?>" class="so-extraslider so-deal modcontent clearfix <?php echo $class_respl?> <?php if($button_page == "top"){echo "button-type1";}else{echo "button-type2";} ?> style2">
        ...
        <div class="extraslider-inner" data-effect="<?php echo $effect?>">
            ...
            ?>
                ...
                <div class="product-thumb transition">
                    <div class="image"><a href="<?php echo $product['href'];?>" target="<?php echo $item_link_target;?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo html_entity_decode($product['name']); ?>" class="img-responsive" /></a></div>
                    <div class="caption">
    ...
    <script type="text/javascript">
        ...
        autoWidth: false,
        responsive: {
            0: 	{ items: <?php echo $nb_column3;?> } ,
            480: { items: <?php echo $nb_column2;?> },
            768: { items: <?php echo $nb_column1;?> },
