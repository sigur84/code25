			...
			<div class="container">
				<div class="row">
					...
					<div class="header-top-right collapsed-block col-xs-6 compact-hidden">
						<h5 class="tabBlockTitle visible-sm visible-xs"><?php /* echo $text_more; */ ?><a class="expander " href="#TabBlock-1"><i class="fa fa-bars"></i></a></h5>
			...
			<div class="container">
			   ...
			   <?php if ($header_type == 'center') { ?>
				 <?php 
					...
					<div class="navbar-logo col-md-2 col-sm-12 col-xs-12 text-center">
						<?php if ($logo) { ?>
			   ...
			   <!--end header variant center-->
				    ...
				    <?php } else { ?>
				    <!-- Logo -->
				    <div class="navbar-logo col-md-2 col-sm-12 col-xs-8">
					   <?php if ($logo) { ?>
					   <a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a>
					   <?php } else { ?>
					   <h1><a href="<?php echo $home; ?>"><?php echo $name; ?></a></h1>
					...
					<div class="col-sm-2 col-md-2 callme"> 
						<!--<div class="dropdown">
							<div class=" dropdown-toggle" style="cursor:pointer;" type="button" data-toggle="dropdown">--> <?php /*
							if($soconfig_general['phone_status']){
								if (isset($soconfig_general[$lang]["contact_number"]) && is_string($soconfig_general[$lang]["contact_number"])) {
								 echo '<div class="navbar-phone" ><i class="fa fa-phone"></i> '.html_entity_decode($soconfig_general[$lang]["contact_number"], ENT_QUOTES, 'UTF-8').'</div>';
								} 
							} */
							?>
						<!--	</div>
							<ul class="dropdown-menu">
							  <li><a href="#"><i class="fa fa-phone1"></i>  0637345024</a></li>
						      <li><a href="#">234567789</a></li>
							  <li><a href="#">123456598</a></li>
							</ul>
						</div> -->
						
						<div class="navbar-phone">
						<i class="fa fa-phone"></i> (044)5926294
						</div>
						
						<div class="navbar-phone">
						<div class="fa"><img src=" http://gorshki.com.ua/catalog/view/theme/so-shoppystore/images/lifecell.png"></div> (063)7345024
						</div>
						<div style="margin-top:5px;"><a href="" class="cals callme_viewform">Перезвоните мне</a></div>
					</div>
					
					<div class="col-sm-2 col-md-2 contact">
					<div style="margin-top:5px;"><i class="fa fa-skype" aria-hidden="true"></i><a href="skype:sales-gorshki">sales-gorshki</a></div>
						<div class="vremya">Пн - Пт - 9.00 - 18.00</div>
					</div>
				    ...
				    <!-- Secondary menu -->
				    <div class="shopping_cart  col-md-2 col-sm-2 col-xs-6">
					   <!--cart desktop-->
					   <?php
