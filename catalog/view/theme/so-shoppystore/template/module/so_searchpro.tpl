...
<div id="sosearchpro" class="sosearchpro-wrapper dropdown <?php echo $additional_class; ?> compact-hidden">
<!-- 
	<button id="dropdownSearch"  class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">

		

	</button> -->

	<div aria-labelledby="dropdownSearch">
