								...
								<div class="item-image">
									<div class="item-img-info">
										...
										<?php if($display_title){
											$title_product= str_replace("..", "", $product['name'])
											?>
										
											<a class="product_img_link" href="<?php echo $product['href'];?>" target="<?php echo $item_link_target;?>" title="<?php echo $product['fullname']; ?>">
										<?php }?>
										...
										<div class="item-content">
											<?php if($display_price) { ?>
												<div  class="content_price">
													...
													<?php } else { ?>
														<span class=" product-price"><?php echo $product['special']; ?></span>&nbsp;&nbsp;
											...
											<?php if($display_addtocart || $display_readmore_link || $display_wishlist || $display_compare) { ?>
													...
													<button type="button" class="addToCart" onclick="cart.add('<?php echo $product['product_id']; ?>');">
														<?php if($nb_column0 != 6) { ?>
