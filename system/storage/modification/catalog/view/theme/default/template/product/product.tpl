		...
		<button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" data-product_id = <?php echo $product_id; ?> class="btn btn-primary btn-lg btn-block callme">Быстрый заказ</button>
          ...
          <div class="rating">
            <p>
              ...
              <?php } ?>
              <?php } ?>
              <a href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $reviews; ?></a> / <a href="http://www.boss.shoes/" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $text_write; ?></a></p>
            <hr>
        ...
        <div class="<?php echo $class; ?>">
          <div class="product-thumb transition">
            ...
            <div class="button-group">
              <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><span class="hidden-xs hidden-sm hidden-md"><i class="fa fa-shopping-cart"></i> <?php echo $button_cart; ?></span></button>
