...
class ModelCheckoutOrder extends Model {
	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
        ...
        if (isset($smopc_form_data['activate']) && $smopc_form_data['activate'] && $smopc_form_data['redirect_from_cart'] && !in_array($smopc_customer_group_id, $smopc_customer_groups) && !in_array($smopc_store_id, $smopc_stores)) {
          if ($comment) {
            $this->session->data['smopc_payment_comment'] = $comment;
          } else {
            $this->session->data['smopc_payment_comment'] = '';
          } 
        }
