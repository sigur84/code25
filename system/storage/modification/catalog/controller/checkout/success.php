...
class ControllerCheckoutSuccess extends Controller {
	public function index() {
        ...
        if (isset($smopc_form_data['activate']) && $smopc_form_data['activate'] && $smopc_form_data['redirect_to_success_page'] == 2 && !in_array($smopc_customer_group_id, $smopc_customer_groups) && !in_array($smopc_store_id, $smopc_stores)) {
          $this->response->redirect($this->url->link('checkout/ocdev_smart_one_page_checkout/success'));
        }
